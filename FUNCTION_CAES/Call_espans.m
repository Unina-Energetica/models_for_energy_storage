function [MyResults,mFileErrorCode]=Call_espans(MyInputs)
...
if Ptk > Press_min && Pload > 500 
    ...
    while iter>0
        ...
        fun = @(mtent)portate_preheater(mtent,T_gas_in,Tamb_in,Tw_in,Ts_in,To_in,massa,m_heater_amb,m_heater_water,m_heater_sun1);
        mtent = 8;
        ...
        if EXITFLAG > 0 && m_heater_oil1<10     
            ...
            [T_gas_out1,Tamb_out,Qheat_amb,Eps_amb,T_gas_out2,Tw_out,Qheat_water,Eps_water,T_gas_out3,Ts_out,Qheat_sun,Eps_sun,T_gas_out4,To_out,Qheat_oil,Eps_oil]=preheater1(T_gas_in,Tamb_in,Tw_in,Ts_in,To_in,massa,m_heater_amb,m_heater_water,m_heater_sun1,m_heater_oil1);
...
mFileErrorCode = 155.1;
MyResults(2)=  mc_t1; % kg/s
mFileErrorCode = 155.2;
MyResults(3)=  mc_t2; % kg/s
mFileErrorCode = 155.3;
MyResults(4)=  mc_t3; % kg/s
mFileErrorCode = 155.4;
MyResults(5)=  eta_average;
mFileErrorCode = 155.5;
MyResults(6)=  eta_1;
mFileErrorCode = 155.6;
MyResults(7)=  eta_2; 
mFileErrorCode = 155.7;
MyResults(8)=  eta_3; 
mFileErrorCode = 155.8;
MyResults(9)=  Pshaft_t1; % kW
mFileErrorCode = 155.9;
MyResults(10)= Pshaft_t2; % kW
mFileErrorCode = 155.11;
MyResults(11)= Pshaft_t3; % kW
mFileErrorCode = 155.12;
MyResults(12)= Pw_tot; % kW
mFileErrorCode = 155.13;
MyResults(13)= P_fromGrid; % kW
mFileErrorCode = 155.14;
MyResults(14)= Tout_t1; % °C
MyResults(15)= Tout_t2; % °C
MyResults(16)= Tout_t3; % °C
mFileErrorCode = 155.15;
