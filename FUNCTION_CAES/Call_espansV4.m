function [MyResults,mFileErrorCode]=Call_espansV4(MyInputs)
...
% m_heater_oil1 = 12;  % Portata di progetto
% m_heater_oil2 = 4.6; % Portata di progetto
% m_heater_oil3 = 4.5; % Portata di progetto
...
% Uscita
P_ob = Pload/0.98; %kW, potenza obiettivo 
% P_ob0 = P_ob;
Patm = 1.013; %bar
...
if Ptk > Press_min && Pload > 500 
    ...
    while iter>0
        ...
        [pass,Nc_T1] = solver_etat_bestX3RV2(Mappa_t1_corr,Mappa_t2_corr,Mappa_t3_corr,f_Eta_c_t1,f_Nc_t2,f_Eta_c_t2,f_Nc_t3,f_Eta_c_t3,beta_1,beta_2,beta_3,Nsol,P_ob,TINC,Ts_in,To_in,m_heater_sun2,m_heater_sun3);    
        ...
        [mc_t1,mc_t2,mc_t3,eta_1,eta_2,eta_3,V_power_shaft(:,1),massa,Nc_T2,Nc_T3,Tout_t(1,:),Matrix_th(:,:),m_heater_oil2,m_heater_oil3] = solver_TrenoX3_explicitoRV2(f_Eta_c_t1,f_Nc_t2,f_Eta_c_t2,f_Nc_t3,f_Eta_c_t3,beta_1,beta_2,beta_3,Nc_T1,Mappa_t1_corr,Mappa_t2_corr,Mappa_t3_corr,TINC,Ts_in,To_in,m_heater_sun2,m_heater_sun3);
        
        mFileErrorCode = 147;
        
        fun = @(mtent)portate_preheaterV2(mtent,T_gas_in,Tamb_in,Tw_in,Ts_in,To_in,massa,m_heater_amb,m_heater_water,m_heater_sun1,Ptk);
        mtent = 7;
        ...
        if EXITFLAG > 0 && m_heater_oil1<8  
        
            [T_gas_out1,Tamb_out,Qheat_amb,Eps_amb,T_gas_out2,Tw_out,Qheat_water,Eps_water,T_gas_out3,Ts_out,Qheat_sun,Eps_sun,T_gas_out4,To_out,Qheat_oil,Eps_oil]=preheater1tsV2(T_gas_in,Tamb_in,Tw_in,Ts_in,To_in,massa,m_heater_amb,m_heater_water,m_heater_sun1,m_heater_oil1);
