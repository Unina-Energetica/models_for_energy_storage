function Y = Treno_compressori_X3_pistoni_ts(Ntent)
% nota la mappa e la potenza disponibile all'albero definisce portata
% corretta, portata istantanea e numero di giri attuali.
global mappa_C1  mappa_C2  To  Ti  pi  po  power  beta_i1  beta_i2  beta_i3  fun_eta_C1  fun_mappa_C2  fun_eta_C2  graf_c3  T_cool1  T_cool2  m_cool1  m_cool2
...
Tin_HE_c1  = Ti*(1 + (beta_i1^eps - 1)/eta_c1)-273.15;  

[~,~,~,~,Tout_HE_c1,~,~,~] = intercooler_centrif_1(T_cool1,Tin_HE_c1,T_cool2,m_cool1,m_c1,m_cool2);

%% Compressore C2 %%

Tin_C2 = Tout_HE_c1+273.15;
...
Tin_HE_c2  = Tin_C2*(1 + (beta_i2^eps - 1)/eta_c2)-273.15;  

[~,~,~,~,Tout_HE_c2,~,~,~] = intercooler_centrif_2(T_cool1,Tin_HE_c2,T_cool2,m_cool1,m_c2,m_cool2);

%% Compressore C3 pistoni %%

Tin_C3 = Tout_HE_c2+273.15;
...
P_C3 = (m_c3*cp_a3*Tin_C3*(beta_i3^eps-1))/(eta_c3);
