...
% Xc1 = mappa_C1(:,:,1); Yc1 = mappa_C1(:,:,2); Zc1 = mappa_C1(:,:,4);

% f_Eta1   = scatteredInterpolant(Xc1(:),Yc1(:),Zc1(:));
...
% m_gas       = m_c1;
% m_cooler    = 15*m_c1;
% [~,Tgas,~,~] = intercooler_compressor(cp_cooler,cp_gas,T_in_cooler,T_in_gas,m_cooler,m_gas);
