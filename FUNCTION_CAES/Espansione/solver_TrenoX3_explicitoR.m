function [mc_t1,mc_t2,mc_t3,eta_1,eta_2,eta_3,V_Pshaft,massa,Nc_t2,Nc_t3,Tout_t,Matrix_th,m_heater_oil2,m_heater_oil3] = solver_TrenoX3_explicitoR(f_Eta_c_t1,f_Nc_t2,f_Eta_c_t2,f_Nc_t3,f_Eta_c_t3,beta_1,beta_2,beta_3,Nc_t1,Mappa_t1_corr,Mappa_t2_corr,Mappa_t3_corr,parameter,Ts_in,To_in,m_heater_sun2,m_heater_sun3) 
%% dati ARIA %%
...
fun = @(mtent)portate_heater2(mtent,Tout_t(1,1),Ts_in,To_in,massa,m_heater_sun2);
mtent = 7.7;
options = optimset('Display','off');
[m_heater_oil2,~,EXITFLAG,~] = fsolve(fun,mtent,options);

if EXITFLAG > 0 || m_heater_oil2<8     
            
    [T_gas_out1,Ts_out,Qheat_sun,Eps_sun,T_gas_out2,To_out,Qheat_oil,Eps_oil]=heater2(Tout_t(1,1),Ts_in,To_in,massa,m_heater_sun2,m_heater_oil2);
  ...
  % Matrix_th(2,1) = 0;  Matrix_th(2,2) = 0;   Matrix_th(2,3) = 0;   Matrix_th(2,4) = 0;   Matrix_th(2,5) = 0;   Matrix_th(2,6) = 0;   Matrix_th(2,7) = 0;   Matrix_th(2,8) = 0;
    ...
    m_heater_oil2   = 8; % Portata di progetto
...
fun = @(mtent)portate_heater3(mtent,Tout_t(1,2),Ts_in,To_in,massa,m_heater_sun3);
mtent = 7.4;
options = optimset('Display','off');
[m_heater_oil3,~,EXITFLAG,~] = fsolve(fun,mtent,options);

if EXITFLAG > 0 || m_heater_oil3<8    
            
    [T_gas_out1,Ts_out,Qheat_sun,Eps_sun,T_gas_out2,To_out,Qheat_oil,Eps_oil]=heater3(Tout_t(1,1),Ts_in,To_in,massa,m_heater_sun3,m_heater_oil3);
  ...
  % Matrix_th(3,1) = 0;  Matrix_th(3,2) = 0;   Matrix_th(3,3) = 0;   Matrix_th(3,4) = 0;   Matrix_th(3,5) = 0;   Matrix_th(3,6) = 0;   Matrix_th(3,7) = 0;   Matrix_th(3,8) = 0;
    ...
    m_heater_oil3   = 8; % Portata di progetto

    [T_gas_out1,Ts_out,Qheat_sun,Eps_sun,T_gas_out2,To_out,Qheat_oil,Eps_oil]=heater2(Tout_t(1,1),Ts_in,To_in,massa,m_heater_sun3,m_heater_oil3);
