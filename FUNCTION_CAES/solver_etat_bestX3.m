function [pass,Nc_T1] = solver_etat_bestX3(mappa_t1,mappa_t2,mappa_t3,f_Eta_c_t1,f_Nc_t2,f_Eta_c_t2,f_Nc_t3,f_Eta_c_t3,beta_1,beta_2,beta_3,Nsol,P_ob,TINC)
...
for y = 1:length(N_aly)
    ...
    [mc_t1test(y),mc_t2test(y),mc_t3test(y),eta_b1(y),eta_b2(y),eta_b3(y),V_shaft(:,y),~,Nc_T2,Nc_T3,~] = solver_TrenoX3_explicito(f_Eta_c_t1,f_Nc_t2,f_Eta_c_t2,f_Nc_t3,f_Eta_c_t3,beta_1,beta_2,beta_3,N_aly(y),mappa_t1,mappa_t2,mappa_t3,TINC);
