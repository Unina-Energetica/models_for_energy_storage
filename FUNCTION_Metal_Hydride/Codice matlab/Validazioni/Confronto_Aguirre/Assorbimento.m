function dyadta = Assorbimento(ta, ya, m_H2_in, Twa)
% Variables
...
m_w   = 0.8393;      % Portata d'acqua di progetto        [kg/s]
...
d_T_a_dta    = ((m_H2_in)*Cp_H2*(Tin_a-T_a)+A*U*(Twa-T_a)-DHa*r_a*m_s*SC/M_MH)/(m_H2_a*Cp_H2+m_s*Cp_s); %Absorption
%d_T_a_dta = A*U*(Twa-T_a)/(m_H2_a*Cp_H2+m_s*Cp_s); %Equation for the temperature increase during absorption
