function dyadta = Assorbimento_4_eq(ta, ya, m_H2_in, Twa, DTml, m_s, A, U, Pa, Ca, Ea, R, M_H2, SC, M_MH, Cp_H2, Cp_s, Tin_a, DHa, DSa, sl, P0)
...
if m_H2_in == 0
    d_m_H2_a_dta = 0;%m_H2_in-r_a*m_s*((M_H2*SC)/M_MH);
    d_m_MH_a_dta = 0;%r_a*m_s;
    d_T_a_dta    = (-(A*U*DTml))/(m_H2_a*Cp_H2+m_s*Cp_s); 
else
